...
import (
	...
	scheme "github.com/caicloud/kubeflow-clientset/clientset/scheme"
...
type TFJobInterface interface {
	...
	UpdateStatus(*v1alpha1.TFJob) (*v1alpha1.TFJob, error)
...
func (c *tFJobs) UpdateStatus(tFJob *v1alpha1.TFJob) (result *v1alpha1.TFJob, err error) {
	result = &v1alpha1.TFJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tfjobs").
