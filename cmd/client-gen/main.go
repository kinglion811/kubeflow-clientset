...
import (
	...
	clientgenargs "github.com/caicloud/kubeflow-clientset/cmd/client-gen/args"
	"github.com/caicloud/kubeflow-clientset/cmd/client-gen/generators"
	"github.com/caicloud/kubeflow-clientset/cmd/client-gen/types"
...
func main() {
	...
	arguments.GoHeaderFilePath = filepath.Join(args.DefaultSourceTree(), "github.com/caicloud/kubeflow-clientset/hack/custom-boilerplate.go.txt")
	flag.Parse()
	var cmdArgs string
